...
<head>
    ...
    <link href="{{ asset('/js/vendor/modernizr-2.6.2.min.js') }}" rel="script">
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    @if(Auth::user()->admin == 1)
                                        <li>{!! Html::link('admin/categories', 'Add Category') !!}</li>
                                        <li>{!! Html::link('admin/products', 'Add Product') !!}</li>
                                    @endif
...
<script>window.jQuery || document.write("{{ asset('js/vendor/jquery-1.9.1.min.js') }}")</script>
<link href="{{ asset('js/plugins.js') }}" rel="script">
<link href="{{ asset('js/main.js') }}" rel="script">
